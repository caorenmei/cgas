...
---@param other string | GameplayTag
---@return boolean
...
---@field tags table<string, GameplayTag>
...
--- 检查是否与另一个容器有任意匹配
---@param other GameplayTagContainer
---@return boolean
...
---@field all_tags GameplayTagContainer
---@field any_tags GameplayTagContainer
---@field none_tags GameplayTagContainer
...
--- 检查容器是否匹配此查询
---@param container GameplayTagContainer
---@return boolean
